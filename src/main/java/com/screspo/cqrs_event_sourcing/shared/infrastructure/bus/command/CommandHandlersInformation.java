...
import com.screspo.cqrs_event_sourcing.shared.domain.bus.command.CommandNotRegisteredError;
...
public final class CommandHandlersInformation {
    ...
    public CommandHandlersInformation() {
        ...
        indexedCommandHandlers = formatHandlers(reflections.getSubTypesOf(CommandHandler.class));
    }
